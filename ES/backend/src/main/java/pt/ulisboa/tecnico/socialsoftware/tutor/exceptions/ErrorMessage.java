...
public enum ErrorMessage {
    ...
    //Same question
    SAME_QUESTION_ALREADY_CONTAINS_THIS_FAILED_ANSWER("The Fail Answer already exists in Same Question. Cannot add %s"),
    CANNOT_REMOVE_SAME_QUESTION("Cannot remove Same Question. There's still Failed Answers%s"),
    ...
    WEEKLY_SCORE_ALREADY_ADDED_TO_SAMEPERCENTAGE("Weekly Score already added to the set in SamePercentage"),
    WEEKLY_SCORE_NOT_EXISTS_IN_SAMEPERCENTAGE("Weekly Score does not exist in SamePercentage"),
    CANNOT_CLOSE_CURRENT_WEEK("Cannot close this week's weekly score"),
