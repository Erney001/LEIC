...
class PythonClient(object):
    ...
    def add_person(self):
        ...
        if type == "mobile":
            person.phone.type = pb2.PhoneType.MOBILE
        elif type == "home":
            person.phone.type = pb2.PhoneType.HOME
        elif type == "work":
            person.phone.type = pb2.PhoneType.WORK
        else:
    ...
    def search_person(self):
        ...
        except Exception: # this is not working with ValueError
    ...
    def update(self):
        ...
        type = input("Enter phone type: [mobile/home/work] ")
        if type == "mobile":
            request.phone.type = pb2.PhoneType.MOBILE
        elif type == "home":
            request.phone.type = pb2.PhoneType.HOME
        elif type == "work":
            request.phone.type = pb2.PhoneType.WORK
        else:
            print("Unknown phone type; leaving as default value.")
            return
        
        try:
            request.phone.number = int(input("Enter phone number: "))
    ...
    def list_all(self):
        ...
        try:
            ...
            for i in response.phoneNumber:
                if i.type == pb2.PhoneType.MOBILE:
                    print("Mobile phone #: ", i.number)
                elif i.type == pb2.PhoneType.HOME:
                    print("Home phone #: ", i.number)
                elif i.type == pb2.PhoneType.WORK:
                    print("Work phone #: ", i.number)
...
def print_person(person):
    ...
    if person.phone.type == pb2.PhoneType.MOBILE:
        print("  Mobile phone #: ", end="")
    elif person.phone.type == pb2.PhoneType.HOME:
        print("  Home phone #: ", end="")
    elif person.phone.type == pb2.PhoneType.WORK:
...
def get_user_choice():
    ...
    print("[4] Update person's phone.")
    print("[5] Get all contacts with a given birthday.")
    print("[q] Quit.")
